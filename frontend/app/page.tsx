...
export default function Home() {
  ...
  const handleSocketIncomingMessage = useCallback((message: string) => {
    ...
    try {
        ...
        console.log('Ignoring message:', message); // Log the message without throwing error
    }
}, []);
  ...
  return (
    <main className="flex justify-center items-center h-[100vh]">
      ...
      <h1 className="text-3xl font-bold mb-4 text-center">Deploy Your Static Website</h1>
        ...
        {logs.length > 0 && (
          <div
            className={`${firaCode.className} text-sm mt-5 border-2 rounded-lg p-4 h-[300px] overflow-y-auto`}
          >
